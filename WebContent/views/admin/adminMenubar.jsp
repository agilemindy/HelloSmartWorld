            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/smartWorld/adminProductListView.do">제품관리</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">매출조회</a></li>
                        <li class="nav-item"><a class="nav-link" href="/smartWorld/inventoryManagementListView.do">재고관리</a></li>
