...
/**
 * Servlet implementation class SalesListViewServlet
 */
@WebServlet("/SalesListView.do")
public class SalesListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SalesListViewServlet() {
        super();
