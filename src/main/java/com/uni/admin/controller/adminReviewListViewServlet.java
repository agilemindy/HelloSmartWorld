...
/**
 * Servlet implementation class adminReviewListViewServlet
 */
@WebServlet("/adminReviewList.do")
public class adminReviewListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminReviewListViewServlet() {
        super();
